...
{
    public class PODetailRepository : Repository<PODetailRepository>, IPODetailRepository
    {
        public PODetailRepository(DbContext contex) : base(contex)
        {
        }
        ...
        public IModelData GetPurchaseOrderDetail(int indexPO)
        {
            try
            {
                var poDetail = ModelSQLserver.PurchaseOrders
                    ...
                    .Select(po_with_supp => new PODetailModel_PODetailPage()
                    {
                ...
                var listPOLine = ModelSQLserver.PurchaseOrderLines
                    ...
                    .Select(pol => new POLModel_PODetailPage()
                    {
                        Id = pol.Id,
